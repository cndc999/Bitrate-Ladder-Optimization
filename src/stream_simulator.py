...
BANDWIDTH_PROFILES: dict[str, list[float]] = {
    "Ổn định (5 Mbps)": [5000] * 60,
    "Biến động vừa":    [5000, 4500, 4000, 3000, 3500, 4000, 5000, 4500, 3000, 2500] * 6,
    "Mạng yếu & chập chờn": [2000, 1000, 500, 200, 1500, 3000, 500, 200, 1000, 2000] * 6,
}
